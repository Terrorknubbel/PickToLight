...
router.get("/logs/:stockId", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.get("/mobileList/:id", async (req, res) => {
  if(req.session.loggedin){
    try {
...
//updates mobileList
router.put("/mobileList", async (req, res) => {
  if(req.session.loggedin){
    try {
...
//finishes a task
router.delete("/mobileList", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.get("/stock/name/:name", async (req, res) => {
  if(req.session.loggedin){
...
router.get("/taskentries/stock/:stockId", async (req, res) => {
  if(req.session.loggedin){
...
router.get("/tasklog/:taskId", async (req, res) => {
  if(req.session.loggedin){
...
//creates new tasklog
router.post("/tasklog", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.get("/stammdaten/:table", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.get("/stammdaten/:table/:name", async (req, res) => {
  if(req.session.loggedin){
      let table;
...
router.post("/stammdaten/:table", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.delete("/stammdaten/:table/:name", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.get("/storageLocation", async (req, res) => {
  if(req.session.loggedin){
    try {
...
router.get("/storageLocation/:id", async (req, res) => {
  if (req.session.loggedin) {
...
router.get("/storageLocation/parent/:id", async (req,res) => {
  if (req.session.loggedin) {
...
router.post("/storageLocation", async (req, res) => {
  if (req.session.loggedin){
    try{
...
router.patch("/storageLocation", async (req,res) => {
  if(req.session.loggedin){
    try {
...
router.patch("/storagePlace", async (req, res) => {
  if (req.session.loggedin) {
    try{
